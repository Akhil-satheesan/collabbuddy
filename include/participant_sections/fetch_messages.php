<?php
// FILE: include/participant_sections/fetch_messages.php (Participant AJAX)

require_once __DIR__ . '/../../include/config.php';
if (session_status() === PHP_SESSION_NONE) session_start();
header('Content-Type: application/json');

if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'participant' || !isset($_GET['group_id'])) {
...
// Authorization Check: Participant ഈ ഗ്രൂപ്പിലെ അംഗമാണോ?
